...
var header = `
<nav id = 'navbarColo' class='navbar navbar-expand-lg navbar-light fixed-top  navbar-fixed border-bottom p-3 px-md-4 mb-3 bg-white shadow-sm'>
  <a class='navbar-brand' href='#' style='font-family: garamond; border-bottom: medium solid black '><strong>B</strong>olt</a>
  ...
  <div class='collapse navbar-collapse' id='navbarText'>
    <ul class='navbar-nav mr-auto'>
      ...
      <li class='nav-item'>
        <a class='nav-link' href='/buy'>About</a>
      </li>
      <li class='nav-item'>
